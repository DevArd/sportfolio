import { MbappeOnChainDatas, MessiOnChainDatas, TalentOnChainDatas, DefaultOnChainDatas } from "@/Constants";
...
export interface ITalent {
    ...
    apy: number;
    price: number;
    onChainDatas: TalentOnChainDatas;
}

export const talents: ITalent[] = [
    // Futbol
    {
        onChainDatas: MessiOnChainDatas,
        apy: Math.random() * 100,
        price: Math.random(),
        name: 'Lionel Messi',
        sport: 'Futbol',
    ...
    {
        onChainDatas: DefaultOnChainDatas,
        apy: Math.random() * 100,
        price: Math.random(),
    ...
    {
        onChainDatas: MbappeOnChainDatas,
        apy: Math.random() * 100,
        price: Math.random(),
        name: 'Kylian Mbappé',
        sport: 'Futbol',
