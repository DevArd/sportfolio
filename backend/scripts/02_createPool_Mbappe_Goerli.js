// npx hardat run ./scripts/02_createPool_Mbappe_Goerli.js --network goerli
...
async function main() {
  ...
  // Check pool address
  console.log("Successfuly created Uniswap liquidity pools :", await factoryContract.getPair(USDC_ADDRESS, MBAPPE_ADDRESS));
}
